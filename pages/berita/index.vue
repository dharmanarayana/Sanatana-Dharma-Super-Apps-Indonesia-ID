  ...
  <div>
    ...
    <div class="px-4 lg:px-0 py-4 space-y-6">
      ...
      <div class="grid lg:grid-cols-[1fr_320px] gap-8">
        <div class="space-y-6">
          <BeritaTabBar />
          <div v-if="loading && (newsItems?.length || 0) === 0" class="space-y-4">
          ...
          <div v-else-if="(newsItems?.length || 0) > 0" class="space-y-4">
        ...
        <aside class="hidden lg:block space-y-6">
          <div class="card p-4">
            ...
            <div v-if="(announcements?.length || 0) > 0" class="space-y-2">
          ...
          <div class="card p-4">
            ...
            <div v-if="(topNews?.length || 0) > 0" class="space-y-3">
