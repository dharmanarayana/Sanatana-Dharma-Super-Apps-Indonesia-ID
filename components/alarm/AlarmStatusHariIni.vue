...
<template>
  <div class="card p-5 bg-gradient-to-br from-brand/10 to-transparent border-brand/20 rounded-3xl">
    <h4 class="text-sm font-bold opacity-70 uppercase tracking-widest mb-4">Status Hari Ini</h4>
